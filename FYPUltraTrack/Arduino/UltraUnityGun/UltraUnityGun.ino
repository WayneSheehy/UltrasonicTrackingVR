...
const char* ssid = "Moto G 5445";
const char* password = "30031993";
...
#define TechoPin D1 // Echo Pin connected to sensor
#define TtrigPin D2 // Trigger Pin connected to sensor
...
//RH_ASK RFdriver(2000, 12, 11);

const int AtrigPin = 2;
const int AechoPin = 8;
...
void loop()
{
 ...
 // Listen for connecting clients
  ...
  distanceA = getDistance(TtrigPin, TechoPin);
  ...
  checkIMU();
   ...
   // Send the distance to the client, along with a break to separate our messages
        client.print(printGyro());
        client.print('\r');
Serial.print(printGyro());
